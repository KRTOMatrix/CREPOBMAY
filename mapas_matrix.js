...
function style1(feature) {
	return {
		fillColor: getColor1(feature.properties.TCRA65T),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup1(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA65T.toFixed(1).toString().replace(".", ",")+
...
function style2(feature) {
	return {
		fillColor: getColor2(feature.properties.TCRA65H),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup2(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA65H.toFixed(1).toString().replace(".", ",")+
			"%<br><strong>Provincia: </strong>"+
			feature.properties.NAMEUNIT_1,
			{direction:"centerleft",sticky:true, permanente:true,offset:[0,-5], pane: 'popups',});	
	};
...
function style3(feature) {
	return {
		fillColor: getColor3(feature.properties.TCRA65M),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup3(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA65M.toFixed(1).toString().replace(".", ",")+
			"%<br><strong>Provincia: </strong>"+
			feature.properties.NAMEUNIT_1,
			{direction:"centerleft",sticky:true, permanente:true,offset:[0,-5], pane: 'popups',});	
	};
...
function style4(feature) {
	return {
		fillColor: getColor4(feature.properties.TCRA80T),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup4(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA80T.toFixed(1).toString().replace(".", ",")+
			"%<br><strong>Provincia: </strong>"+
			feature.properties.NAMEUNIT_1,
			{direction:"centerleft",sticky:true, permanente:true,offset:[0,-5], pane: 'popups',});	
	};
...
function style5(feature) {
	return {
		fillColor: getColor5(feature.properties.TCRA80H),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup5(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA80H.toFixed(1).toString().replace(".", ",")+
			"%<br><strong>Provincia: </strong>"+
			feature.properties.NAMEUNIT_1,
			{direction:"centerleft",sticky:true, permanente:true,offset:[0,-5], pane: 'popups',});	
	};
...
function style6(feature) {
	return {
		fillColor: getColor6(feature.properties.TCRA80M),
		weight: 0.9,
		opacity: 1,
		color: 'black',
		dashArray: '1',
...
function popup6(feature, layer) {
	...
	if (feature.properties && feature.properties.NAMEUNIT_1) {
		layer.bindTooltip("<strong>Tasa: </strong>"+  
			feature.properties.TCRA80M.toFixed(1).toString().replace(".", ",")+
			"%<br><strong>Provincia: </strong>"+
			feature.properties.NAMEUNIT_1,
			{direction:"centerleft",sticky:true, permanente:true,offset:[0,-5], pane: 'popups',});	
	};
